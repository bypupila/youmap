...
export function YoutubeImportStep({
  ...
  const validationBadgeClass =
    channelValidationState === "valid"
      ...
      : "border-[rgba(255, 90, 61,0.3)] bg-[rgba(255, 90, 61,0.12)] text-[#ff8b8b]";
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <label className="block sm:col-span-1">
          ...
          <input
            ...
            className="h-11 w-full rounded-2xl border border-white/10 bg-[#121212] px-4 text-[14px] text-[#f1f1f1] outline-none placeholder:text-[#717171] focus:border-[rgba(255, 90, 61,0.6)]"
          />
        </label>
        <label className="block sm:col-span-1">
      ...
      <label className="block">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-11 min-w-0 flex-1 rounded-2xl border border-white/10 bg-[#121212] px-4 text-[14px] text-[#f1f1f1] outline-none placeholder:text-[#717171] focus:border-[rgba(255, 90, 61,0.6)]"
          />
          <button
            type="button"
